...
// --- CONSTANTS & HELPERS (Keep existing logic) ---
...
const CalendarDayDetail: React.FC<CalendarDayDetailProps> = ({ date, onDateChange }) => {
    ...
    return (
        <div className="flex flex-col gap-3 md:gap-6">
            ...
            {/* 1. Date Split View - Dark Mode Optimized */}
            ...
            {/* 2. Details List - Compact & High Contrast */}
            ...
            {/* 3. Good / Bad Cards - Enhanced Visibility */}
