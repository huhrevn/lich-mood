...
interface PageMonthCalendarProps {
    date: Date;
    onDateChange: (newDate: Date) => void;
    onTogglePicker?: () => void;
}

const PageMonthCalendar: React.FC<PageMonthCalendarProps> = ({ date, onDateChange, onTogglePicker }) => {
    ...
    return (
        <div className="page-month-calendar w-full select-none h-auto flex flex-col font-display overflow-visible">
            ...
            {/* 
                PAGE CALENDAR GRID STYLES:
                - Maintains the responsive logic from previous iteration (horizontal priority but larger)
                - lg:gap-3 (Standard)
                - lg:aspect-[1.45/1]
            */}
...
export default PageMonthCalendar;
